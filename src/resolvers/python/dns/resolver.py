...
class Resolver(object):
    ...
    def query(self, qname, rdtype=dns.rdatatype.A, rdclass=dns.rdataclass.IN,
              tcp=False, source=None, raise_on_no_answer=True, raise_on_nx=True, source_port=0):
        ...
        for qname in qnames_to_try:
            ...
            all_nxdomain = False
            break
        if all_nxdomain and raise_on_nx:
            raise NXDOMAIN
...
def query(qname, rdtype=dns.rdatatype.A, rdclass=dns.rdataclass.IN,
          tcp=False, source=None, raise_on_no_answer=True, raise_on_nx=True,
          source_port=0):
    """Query nameservers to find the answer to the question.
    ...
    return get_default_resolver().query(qname, rdtype, rdclass, tcp, source,
                                        raise_on_no_answer, raise_on_nx, source_port)
